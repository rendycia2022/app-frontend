...
onBeforeMount( async() => {
    ...
    if(token){
        ...
        if(auth.data.status == 200){
            router.push({ path: '/cia/dashboard' })
        }
    }  
});
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    <div class="text-center mb-5">
                        <div class="text-900 text-3xl font-medium mb-3">Welcome, to CIA system!</div>
                    ...
                    <div>
                        ...
                        <div class="flex align-items-center justify-content-between mb-5 gap-5">
                            ...
                            <router-link to="/cia/auth/forgot" class="text-orange-500 font-medium no-underline ml-2 text-right cursor-pointer">Forgot password?</router-link>
                        </div>
