...
const fetching = async () =>{
    const response = await axiosProject.get('/project/summary/budget/',{ 
        params:{
...
const deleteProduct = async () => {
    ...
    const response = await axiosProject.delete('/project/summary/budget',{data: {data},
        params: local.value
    });
    ...
    >
        <template #header>
            <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                <div style="text-align:left">
                    <div class="text-xl font-bold mr-2">Budgets Order</div>
                </div>
        ...
        <Column headerStyle="" header="Download">
            <template #body="slotProps">
                <a :href="'http://103.188.175.175:8021/api/public/files/budget/'+slotProps.data.indirect_request_id+'/pdf?project_id='+local.project_id+'&user_id='+local.user_id" target="_blank">
