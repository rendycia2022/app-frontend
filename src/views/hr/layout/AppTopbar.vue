...
import { axiosHR, axiosProject } from '../../../service/axios';
...
<template>
    <div class="layout-topbar">
        ...
        <button v-if="local.role != 2 && local.id" class="p-link layout-menu-button layout-topbar-button" @click="onMenuToggle()">
